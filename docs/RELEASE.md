...
smoke-test diagnostic reports include the requested release version.
...
commit and requested version with matching installer hash, size, and build
timestamp before creating the prerelease.
