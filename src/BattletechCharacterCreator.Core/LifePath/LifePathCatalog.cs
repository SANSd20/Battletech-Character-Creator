...
public static class LifePathCatalog
{
    ...
    [
        ...
        Affiliation("major-periphery", "Major Periphery State", 75,
            [Trait("Equipped", -50)], [], ["Language/English"], "Periphery",
        ...
        Affiliation("deep-periphery", "Deep Periphery", 50,
            [Attribute("WIL", 60), Trait("Equipped", -80)], [], Languages, "Periphery",
        ...
        new("comstar", "ComStar",
            "ComStar order affiliation; add the selected birth affiliation cost separately.",
            50,
        ...
        new("word-of-blake", "Word of Blake",
            "Word of Blake order affiliation; add the selected birth affiliation cost separately.",
            50,
    ...
    [
        ...
        School("university", "University", 710,
            ...
            [Choice("interest", "Interest", EffectTarget.Skill, 20, 1, Interests),
                FlexibleChoice("flex", "Flexible XP", 220, 1)],
            ["Cartographer", "Communications", "General Studies", "Manager", "Scientist",
                "Technician - Civilian"],
        ...
        School("police-academy", "Police Academy", 680,
            ...
            [Choice("driving", "Driving specialty", EffectTarget.Skill, 20, 1,
                ...
                FlexibleChoice("flex", "Flexible XP", 140, 1)],
            ["Police Officer"],
    ...
    private static IReadOnlyList<LifePathModule> CreateSubAffiliations(
        ...
        affiliationId switch
        {
            ...
            [
                ...
                Sub("St. Ives Commonality",
                    [Attribute("WIL", 50), Attribute("EDG", 50), Trait("Reputation", -100),
                        Trait("Wealth", 50), Trait("Connections", 50),
            ...
            [
                Sub("Azami",
                    [Attribute("WIL", 90), Trait("Compulsion/Xenophobia", -50),
                        Trait("Equipped", -50), Trait("Thick-Skinned", 100), Trait("Wealth", -25),
                        Skill("Language/Arabic", 10), Skill("Language/Japanese", -10),
                        Skill("Martial Arts", 10), Skill("Melee Weapons", 10), Skill("Riding", 5)],
    ...
    [
        Sub("Circinus Federation",
            ...
            [Choice("language", "Language", EffectTarget.Skill, 10, 1,
                ["Language/German", "Language/Spanish"]),
                Choice("skills", "Frontier skills", EffectTarget.Skill, 10, 3,
        ...
        Sub("Magistracy of Canopus",
            ...
            [Choice("language", "Language", EffectTarget.Skill, 10, 1,
                ["Language/Greek", "Language/Romanian", "Language/Spanish", "Language/Urdu"]),
        ...
        Sub("Marian Hegemony",
            [Attribute("WIL", 100), Trait("Compulsion/Paranoid", -50),
                ...
                Skill("Language/Latin", 15), Skill("Protocol/Marian", 10), Skill("Strategy", 5)],
            [Choice("language", "Language", EffectTarget.Skill, 10, 1,
                ["Language/Latin", "Language/French", "Language/German", "Language/Greek",
    ...
    [
        Sub("Hanseatic League",
            [Trait("Citizenship", 30), Trait("Compulsion/Distrust Lyrans", -40),
                Skill("Appraisal", 10), Skill("Negotiation", 20), Skill("Protocol/Hanseatic", 10)],
            [Choice("language", "Language", EffectTarget.Skill, 10, 1,
                ["Language/German", "Language/English"])]),
        Sub("Castilian Principalities",
            [Attribute("DEX", 25), Trait("Compulsion/Castilian Honor Code", -20),
                Trait("Compulsion/Hatred of Umayyads", -20), Skill("Martial Arts/Basic", 15),
        ...
        Sub("JarnFolk",
            [Attribute("RFL", 20), Trait("Compulsion/Xenophobic", -10),
                ...
                Skill("Negotiation", 15), Skill("Protocol/JarnFolk Families", 15)],
            [Choice("language", "Language", EffectTarget.Skill, 10, 1,
                ["Language/JarnFolk Norse", "Language/Danish", "Language/English",
    ...
    [
        ...
        Sub("Jade Falcon",
            [Attribute("WIL", 25), Trait("Compulsion/Falcon Pride", -75),
                ...
                Skill("Acting/Intimidation", 10), Skill("Martial Arts", 15),
    ...
    [
        ...
        Sub("Fire Mandrill",
            [Attribute("WIL", 25), Trait("Compulsion/Fire Mandrill Fanaticism", -100),
                ...
                Trait("Reputation", -25), Skill("Language/Secondary", 20),
    ...
    [
        Sub("Belter",
            [Attribute("STR", -25), Attribute("BOD", -25),
                ...
                Trait("Wealth", 50), Skill("Navigation/Space", 15), Skill("Survival", 20),
                Skill("Zero-G Operations", 15)],
            [Choice("traits", "Adaptation traits", EffectTarget.Trait, 50, 2,
                ["Ambidextrous", "Attractive", "Exceptional Attribute/STR", "Fast Learner",
                ...
                Choice("skills", "Space skills", EffectTarget.Skill, 10, 2,
                    ["Driving", .. Interests, .. Languages, "MedTech", "Piloting/Aerospace",
                        "Sensor Operations", .. Technicians])]),
        Sub("Lunar Citizen",
            [Attribute("STR", -20), Attribute("BOD", -20), Attribute("INT", 50),
                Attribute("WIL", 40), Attribute("EDG", -25), Trait("Equipped", 25),
                Trait("Poor Vision", -25), Trait("Thick-Skinned", 25), Trait("Wealth", 50)]),
        Sub("Martian Citizen",
            [Attribute("STR", -15), Attribute("WIL", 50), Trait("Equipped", 65),
                Trait("Introvert", -25), Trait("Poor Vision", -25), Trait("Reputation", -25),
                Trait("Thick-Skinned", 25), Trait("Wealth", 35), Skill("Negotiation", 10),
    ...
    [
        ...
        Sub("Generic",
            [Attribute("STR", -15), Attribute("WIL", 50), Trait("Introvert", -10),
                Skill("Negotiation", 10)],
            [Choice("interest", "Interest", EffectTarget.Skill, 10, 1, Interests)]),
        Sub("Mercenary",
        ...
        Sub("Pirate",
            ...
            [Choice("language", "Language", EffectTarget.Skill, 10, 1, Languages),
                Choice("skills", "Pirate skills", EffectTarget.Skill, 15, 3,
                    ["Acting", "Escape Artist", "Martial Arts", "Melee Weapons",
